...
2. **強みとひとことを交互に置く。** 強みは発注側が判断に使う情報、ひとことは人が見える情報。
   どちらかに偏ると見ていられなくなる。
3. **売り込みの直後に人の言葉を置く。** S6の「角だけは手で縫います」の直後に
   「糸の締まり具合だけ見ています」。これで宣伝に聞こえなくなる。
...
| 42-62 | S4 裁断 | 工程 → ひとこと「毎回緊張します」→ 強み「量産も少ない数も」 |
| 62-82 | S5 下仕事・職人の目 | 工程 ＋ ひとこと二つ。**強みは入れない** |
| 82-102 | S6 縫製 | 強み「角だけは手で」＋ ひとこと「ほかのことは考えていません」 |
| 102-122 | S7 検品（作業音が消える） | 工程 ＋ 思い「一ミリ狂ったら作り直します」 |
