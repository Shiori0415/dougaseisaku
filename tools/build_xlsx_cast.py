...
MATRIX = [
    ...
    ("ほかに要る人", "すれ違う人 二〜四人。知人・友人かエキストラ。うち振り返る一人だけは選ぶ",
     "なし", "なし", False),
...
DETAIL1 = [
    ...
    ("すれ違う人（S6）", "二〜四人。うち振り返る一人だけは別に選ぶ",
     "ロビーを歩くその他大勢なので年齢・性別はばらけてよい。知人・友人に頼むか、エキストラを手配する。"
     "ただし振り返り方が不自然だと、ここが一番安っぽくなる。振り返って、一拍見て、また前を向く ── これができる人を一人"),
