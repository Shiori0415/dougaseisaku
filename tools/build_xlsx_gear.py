...
GEAR = [
 ...
 ("A", "三脚（雲台付き）",
  ...
  "Velbon シェルパ 635III N（SHR635-3N）", 25000,
  "https://www.amazon.co.jp/dp/B08N4QDVDF",
  "脚が太くなり（脚径29mm）四段から三段になるので、揺れが止まるまでが速い。EX-440は細い四段なので、伸ばすと録画の頭に微振動が乗る。全高も179cmまで伸び、クイックシューでカメラの付け外しが速い（一人で撮るときに効く）。ただし雲台は三ウェイなので、動かしながら撮るなめらかさはビデオ雲台に及ばない",
  "低＝掲載に幅あり（3,012／6,018）／上＝掲載に大きな開きあり（18,984〜39,800）・表はご指定の25,000で概算"),
 ("B", "マクロレンズ",
...
NOTES = [
 ...
 ("・幅があるもの：三脚（低3,012／6,018、上18,984〜39,800）、マクロレンズの上（中古50,100〜53,700）。", MUTED, False),
 ...
 ("", MUTED, False),
 ("三脚のアップグレード候補（同じ二万五千円台で二つ）", ACCENT, True),
 ("・ベルボン シェルパ635III N ＝ 三ウェイ雲台／三段・脚径29mm／全高179cm（EV含む）・139cm（EV無し）／縮長67cm／質量2.43kg／耐荷重3kg（脚最大8kg）", MUTED, False),
 ("・NEEWER LL27 ＝ フルード（ビデオ）雲台／全高89.4〜192cm／質量4.0kg／耐荷重8kg／アルミ合金／NEEWER公式24,999円", MUTED, False),
 ("・据えて撮る画（③⑦の固定・①⑤⑥の真俯瞰）が中心で、一人で持ち運ぶ回数が多いならシェルパ。", MUTED, False),
 ("・⑥の「工房を歩くカメラ」や①の横移動でパンを使うなら、フルード雲台のLL27。ただし4kgあり、持ち運びは重くなります。", MUTED, False),
 ("・NEEWERは照明でも採用しているブランドですが、メーカー公式ではない量販ブランドです。発注前にサクラチェッカーでご確認ください。", MUTED, False),
 ("", MUTED, False),
