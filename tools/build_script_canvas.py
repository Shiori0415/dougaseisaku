...
HEIGHT = {"01": 1288, "02": 1844, "03": 1075, "04": 970, "05": 1816, "06": 1946, "07": 1093, "08": 1528}
...
"01": ("音楽で持たせる二十五秒。セリフはなく、最後にナレーションが一言だけ入る。"
       "<b>支度は撮らない。一色目から始めて、三回替えて全部で四色。</b>切り替わりは必ず手前を何かが横切るか扉を通る前ボケで行い、"
       "抜けた瞬間に服と革の色が変わっている。<b>一か所で撮り切る。何色を使うかは撮影までに決める。</b>"),
...
"01": {
 1: ("全体＝全身が入る引き、歩いてくる正面。腰より上＝同じ位置から寄るだけで、立ち位置は変えない。"
     "三脚で水平を保つ。カメラの高さは胸の高さで固定し、最後まで変えない。",
     "音楽。足音を薄く。", "出さない。"),
 ...
 3: ("<b>ガラスの扉を通った瞬間につなぐ。</b>扉が画面を覆う一拍を使う。ガラス越しの自然光のみ。",
     "音楽。扉の開閉音を一つ。", "出さない。"),
 4: ("<b>手前を人が横切った瞬間に四色目。</b>到着点なので少し引く。立ち止まったらカメラも止める。",
     "音楽。ここでいちばん明るくなる。", "出さない。"),
 5: ("<b>すれ違う人の体が手前を横切るたびに、服と鞄が入れ替わる。</b>"
     "<b>三脚キャスターで、歩く人と同じ速さで横に動く。</b>腰にピントを合わせたまま追う。"
     "二カット目は<b>すれ違った相手が振り返る</b>ところまで残す。",
     "音楽。足音と人のざわめきを薄く。", "出さない。"),
 6: ("バッグのアップ＝寄りで固定。四色＝真俯瞰で固定。ロゴ＝白バック。",
     "<b>音楽が一段落ちて、ナレーションが一言だけ入る ──「毎日をカラフルに」。</b>",
     "四色が並ぶ画に重ねる。<br><b>同じ道を、違う私で。</b><br>THE SAME ROUTE, A DIFFERENT ME."),
},
"02": {
 ...
 5: ("<b>革を曲げる（胸の高さ・腕と革だけ）</b> → 針の超マクロ → <b>工房の引き（人が入る）</b> → 手縫いの寄り → "
     "<b>もう一段引いた工房</b> → 刃の超マクロ。六カット。"
     "<b>寄りと引きを交互に入れて、機械と手の両方でやっていることと、誰が作っているかを同時に見せる。</b>"
     "引きの二枚は参考動画に出てくる順どおり。",
     "<b>革がしなる音 → ミシンの連続音 → 糸を引き締める音 → 刃が入る一音。</b>ここだけ少し長く聞かせる。",
     "<b>縫う</b> ／ Stitching<br><span style='color:#8a7a63'>手縫いのカットでは替えず、シーンを通して一枚のまま。</span>"),
 6: ("斜め上から（縫い代を開く）→ 手元の寄り（縁を指で起こす）→ 横の寄り（断面に道具を当てる）。三カット。"
     "<b>コバ塗りの直前まで持っていくための三枚。</b>ここで断面が整うから、次のカットで色が乗る。"
     "<b>S8とは別の写真・別の画角で撮る。</b>",
     "指が革をこする音、道具が断面を走る音。<b>まだ静かに。</b>",
