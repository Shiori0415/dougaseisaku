...
HEIGHT = {"01": 1121, "02": 1294, "03": 864, "04": 693, "05": 1560, "06": 1714, "07": 825, "08": 1142}
...
"06": {
 1: ("空撮で降りて建物へ。<b>最後は通路を奥へ進むトラッキング</b>（歩きながら・消失点を画面の中心に。"
     "ここは切らずに長めに回す）。<b>ここではまだ人を出さない。</b>",
     "街の音 → 工房の音。<b>終わりぎわに佐藤さんの声が先に入りはじめる（Jカット）。</b>",
