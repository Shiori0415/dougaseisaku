...
HEIGHT = {"01": 1121, "02": 1271, "03": 864, "04": 693, "05": 1560, "06": 1723, "07": 825, "08": 1142}
...
"06": {
 1: ("空撮で降りて建物へ。<b>ここではまだ人を出さない。</b>",
     "街の音。<b>終わりぎわに佐藤さんの声が先に入りはじめる（Jカット）。</b>",
     "<b>佐藤さん</b>「向島の、この建物です。ここで、ブランドさんのお品を作っています。中をご案内します。」"),
 2: ("<b>通路を奥へ進むトラッキング</b>（歩きながら・消失点を画面の中心に。ここは切らずに長めに回す）"
     "→ 全景の引き → 機械と人（人は引きの中に小さく）。<b>まだ顔は出さない。</b>"
     "暗めの画にして、革の色だけを立てる。",
     "工房の作業音。声はその上に流れ続ける。",
     "<b>佐藤さん</b>「機械はひととおりそろっています。人の手が要るところは、人がやります。"
     "数が少なくても、まとまっても、動かす場所は同じです。」"),
 3: ("機械の超クローズ → 材料の壁を正面から → <b>佐藤さんの引き。ここで初めて人が画に映る。</b>",
     "作業音が続く。声はそのまま。",
     "<b>佐藤さん</b>「機械も材料も、ここに全部あります。外に出さずに、この中で最後まで作れます。」<br>"
     "<span style='color:#8a7a63'>機械の名前は言わない。何をする機械かは説明しないほうが、見ている側の目が止まる。</span>"),
 4: ("棚は<b>奥行きが出る位置</b>から。金型が並ぶ棚 → 型紙を置く手の寄り。",
     "棚の音、金型を抜く音。",
     "<b>佐藤さん</b>「革は、お預かりするものも、こちらで用意するものもあります。金型は品番ごとに置いてあります。"
     "一度作った型は残しますので、二回目からは早いです。」"),
 5: ("裁断機が下りる（横）→ 革包丁の寄り → 裁ち上がったパーツの俯瞰。",
     "プレスの音、包丁の音。",
 ...
 6: ("折り目つけ（寄り）→ スプレー（寄り）→ <b>コバ塗りは超マクロ</b> → 職人の目だけの超マクロ。",
