...
MAP = {
 ...
 ("01",2):("屋外・街","通勤路の並木道（①・同じ画角を使い回す）",CAM+"／レフ板"),
 ("01",3):("屋外・街","通勤路の並木道（①・同じ画角を使い回す）",CAM+"／レフ板"),
 ("01",4):("屋外・街","通勤路の並木道（①・同じ画角を使い回す）",CAM+"／レフ板"),
 ("01",5):("屋外・街","駅の構内（①）",CAM+"／レフ板"),
 ("01",6):("屋外・街","駅の構内（①）",CAM+"／レフ板"),
 ("01",7):("屋外・街","会社のロビー（①の到着点）",CAM+"／レフ板"),
 ("01",8):("白台・物撮り","五色を並べる（①の締め）",CAM+"／照明1灯／白台"),
 ("02",1):("工房・裁つ","作業台・真俯瞰と横（②）",MAC+"／スマホ（音の別録り）"),
 ("02",2):("工房・裁つ","作業台・真俯瞰と横（②）",MAC+"／スマホ（音の別録り）"),
 ("02",3):("工房・下仕事","作業台・目打ちと菱目打ち（②）",MAC+"／スマホ（音の別録り）"),
 ("02",4):("工房・下仕事","作業台・金具と刻印（②）",MAC+"／スマホ（音の別録り）"),
 ("02",5):("工房・縫う","作業台・真俯瞰と横（②）",MAC+"／スマホ（音の別録り）"),
 ("02",6):("工房・コバ","作業台・超マクロ（②）",MAC+"／スマホ（音の別録り）"),
 ("02",7):("工房・コバ","作業台・超マクロ（②）",MAC+"／スマホ（音の別録り）"),
 ("02",8):("お客様・街","使われている場所（②の締め）",CAM),
 ...
 ("06",5):("工房・下仕事","折り目つけ・貼り合わせ・コバ塗り（⑥）",MAC),
 ...
 ("08",1):("店舗","外観と作っているところ（⑧のつかみ）",CAM+"／レフ板"),
 ("08",2):("店舗","商品と空間（⑧のつかみ）",CAM+"／マクロレンズ／照明1灯"),
 ("08",3):("インタビュー","購入者（⑧）",ITV),
 ("08",4):("インタビュー","購入者（⑧）",ITV),
 ("08",5):("お客様・街","使っている場面（⑧）",CAM),
 ("08",6):("インタビュー","購入者（⑧）",ITV),
 ("08",7):("店舗","見送り（⑧の締め）",CAM+"／レフ板"),
 ("08",8):("締めカード","撮影不要。白に抜いてロゴだけ","撮影不要"),
}

# シーン単位ではなくコマ単位で場所が変わるもの（インタビューのカットなど）
SHOT_MAP = {
 ("08",3,2):("店舗","商品と空間（⑧のつかみ）",CAM+"／マクロレンズ／照明1灯"),
 ("08",3,3):("店舗","商品と空間（⑧のつかみ）",CAM+"／マクロレンズ／照明1灯"),
 ("08",4,2):("店舗","商品と空間（⑧のつかみ）",CAM+"／マクロレンズ／照明1灯"),
 ("08",4,3):("店舗","商品と空間（⑧のつかみ）",CAM+"／マクロレンズ／照明1灯"),
 ("08",6,2):("お客様・街","使っている場面（⑧）",CAM),
 ("08",6,3):("お客様・街","使っている場面（⑧）",CAM),
...
EXTRA = [
 ...
 ("インタビュー","くさがやさん（⑤⑥）",ITV,"⑤⑥",
  "店舗での接客と、店に並ぶまでの話を一言。顔出しが難しければ手元だけのバージョンも撮る"),
