...
PAGES = [
 ...
 dict(no="05", jp="1979年から、東京で。", en="Since 1979, Tokyo",
  ...
  rows=[
   ("S1 刻印・沿革","0-12秒",[
     ("5_S1_01_刻印風マクロ_金属に光る文字","黒。刻印が押され、革に沈む（超マクロ）<br><span style='color:#a8763e'>ナレーション開始</span>"),
     ("5_S1_02_窪みに光が差す赤熱マクロ","窪みに光が差す。そこに<b>年号テロップ</b>が重なる"),
     ("5_S1_03_工房の全景ハイアングル","引くと向島工房の全景になる（ハイアングル）"),
   ]),
   ("S2 製造・全員の職人","12-40秒",[
     ("5_S3_01_原反が広げられる","原反が広げられる（真俯瞰）"),
     ("5_S3_02_手元での精密作業","裁断→縫製→コバ磨き。<b>職人を一人ずつ</b>、複数カットで（鍛治島参考の画角）"),
     ("5_S3_03_検品する横顔","検品。<span style='color:#a8763e'>ナレーション一度止まる</span>"),
   ]),
   ("S3 会社の姿","40-60秒",[
     (None,"Brooklyn店舗の外観・店内（撮影して差し替え）"),
     (None,"企画中の新作サンプルが並ぶ（撮影して差し替え）<br><span style='color:#a8763e'>ナレーション再開</span>"),
     (None,"<b>草ヶ谷さん</b>が革を漉く・仕上げる手元（撮影して差し替え）"),
   ]),
   ("S4 使われる・締め","60-75秒",[
     (None,"購入され、店員から手渡される瞬間（撮影して差し替え）"),
     (None,"実際に使われている手元（撮影して差し替え）<br><span style='color:#a8763e'>ナレーション最後の一言</span>"),
     (None,"ナレーションが終わり → テロップ → ロゴ"),
   ]),
  ], pn=7, total=T),
