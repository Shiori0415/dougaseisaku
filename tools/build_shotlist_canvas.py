...
DAYS = [
 ...
 dict(key="d1", no="暗い一本の日", place="向島工房", theme="工房が空いている日に、暗室を作って撮る",
      ...
      cond="<b>工房が動いている日中は、窓を塞いで暗室にできない。</b>工房が空いている休日に借りて撮る。平日の終業後（十七時以降）でも同じことができる。八本でいちばん照明が難しいので、ほかの三日で手が慣れてから最後に。",
      gear="カメラ／三脚／白い板／黒い布／段ボール／ライト一灯",
      keys=["<b>工房の人が帰ってから、または休日に。</b>暗室を組むのに四十分みておく。",
...
# 実際に描かせて測った高さ
HEIGHT = {"cover": 1044, "d1": 1047, "d2": 2928, "d3": 3003, "d4": 1859, "cast": 1062,
