...
DAYS = [
 dict(key="d1", no="暗い一本の日", place="向島工房", theme="人を待たずに撮れるものだけ",
      ...
      cond="製作日も出演者の予定も待たなくてよい。いちばん先に押さえられる。",
 ...
 dict(key="d2", no="店の日", place="店舗・事務所・屋上", theme="インタビューを録り、店で撮るものを一日で",
      ...
      cond="製作日を待たなくてよい。購入者の予定が合わなければ、窓辺・屋上・見送りだけ別の日に切り出す。",
 ...
 dict(key="d3", no="工房の日", place="向島工房", theme="佐藤さんのインタビューと、機械の前ごとに二本",
      ...
      toc=[("06", "佐藤さんのインタビュー、入口と通路、革と金型、裁断、下仕事、縫製、検品、梱包"),
           ...
           ("05", "製造シーンは撮らず、⑥の画を使う")],
      cond="<b>ブルックリンの品を作っている日に合わせる。</b>佐藤さんの返事で動くのは、この日だけ。",
 ...
 dict(key="d4", no="モデルの日", place="東京国際フォーラム → 表参道",
      theme="出演者を立てて撮る二本", date="10月6日（火）",
