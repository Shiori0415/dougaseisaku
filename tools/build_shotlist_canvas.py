...
("02",1):("工房のチーム（棚のそばに入ってよい）", "革のロールが並ぶ棚"),
("02",2):("佐藤さんと工房のチーム", "抜き型、革、裁断機"),
("02",3):("佐藤さんと工房のチーム", "革 二枚、型"),
("02",4):("佐藤さんと工房のチーム、くさがやさん（引きと目元だけ）", "ミシン、糸、革、手縫いの道具"),
("02",5):("佐藤さんと工房のチーム", "刃、道具、革"),
("02",6):("佐藤さんと工房のチーム", "コバ塗料、道具、断面"),
("02",7):("佐藤さんと工房のチーム", "木槌、道具、立ち上がった鞄"),
("02",8):("佐藤さんと工房のチーム", "完成した鞄、ロゴ"),
...
("05",4):("―（⑥の画を使う）", "―"),
("05",5):("―", "店内の商品、ショーウィンドウ"),
("05",6):("くさがやさん（または内藤さん・渡辺さん。⑧S1の3枚目で手元が映る人と同じ）、購入者",
 "商品、ノートPC"),
("05",7):("永尾社長", "ロゴ"),
