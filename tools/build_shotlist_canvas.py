...
DAYS = [
 dict(key="d2", no="10月1日", place="店舗・事務所", theme="開店前に⑤、そのまま⑦",
      ...
      setups=[('10:30〜10:50', '【開店前】店舗の机（打ち合わせの場所）', [("05", 2)],
              ...
              ('12:00〜13:25', 'Bロール（まとめて撮る）', [("05", 5), ("05", 3), ("07", 2), ("07", 3), ("07", 5)],
               '人が映らないカット。まとめて撮る。')]),
 dict(key="d5", no="10月2日", place="店舗", theme="午前は購入者、午後は③",
 ...
 dict(key="d4", no="10月6日", place="東京国際フォーラム → 表参道",
...
CAST = [
 ...
 ("⑤⑥", None, "10月1日・10月5日", "映る（バストショット・横顔）",
  "襟元と髪だけ、撮る直前に鏡で見る。",
  "ふだんの仕事着。<br>永尾社長・くさがやさんは10月1日、佐藤さんは10月5日。",
...
# 実際に描かせて測った高さ
HEIGHT = {"cover": 819, "d2": 1461, "d5": 1850, "d3": 2350, "d4": 1786, "cast": 1239}
