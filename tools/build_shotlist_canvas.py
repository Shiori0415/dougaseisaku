...
DAYS = [
 ...
 dict(key="d5", no="購入者の日", place="店舗", theme="購入者に出ていただく日。⑧と⑤の購入シーン",
      ...
      keys=["<b>購入者の拘束は 9:00〜11:45。</b>⑧と⑤の購入シーンに続けて出ていただく。",
            "外のカットを先にまとめ、そのあと中へ入る。行き来を一度で済ませる。",
            "<b>窓辺のインタビューは最後。</b>撮り慣れて、落ち着いてから話してもらう。",
            "顔出しの範囲を、撮る前に本人へ確認する。"],
      setups=[("9:00〜9:20", "【開店前】店の外 → 入口 → 中へ入るところ", [("08", 1)],
               "外から中へ入るところまで、切らずに追う。"),
              ("9:20〜9:55", "【開店前】店の前・店の前の通り", [("08", 5), ("08", 7)],
               "<b>外のカットはここでまとめる。</b>使っている場面と見送りを続けて撮る。"),
...
# 実際に描かせて測った高さ
HEIGHT = {"cover": 1138, "d2": 1847, "d5": 1677, "d4": 2480, "d3": 3071, "d1": 1325, "cast": 1217}
