...
DAYS = [
 dict(key="d1", no="暗い一本の日", place="向島工房", theme="人を待たずに撮れるものだけ",
      date="未定",
      toc=[("03", "五シーンすべて（窓を塞いだ一角）")],
      cond="ブルックリンの製作日も、出演者の予定も待たなくてよい。いちばん先に押さえられる日。",
      lead="工房が動いていなくても撮れる一本だけの半日。窓を塞いだ一角で③を撮り切る。"
           "人が要らず、外の天気にも左右されないので、いちばん先に押さえられる。",
 ...
 dict(key="d2", no="店の日", place="店舗・事務所・屋上", theme="インタビューを録り、店で撮るものを一日で",
      date="未定",
      ...
      lead="<b>永尾社長とくさがやさんのインタビューを、店内で続けて録る。</b>⑤の声はこの日で全部そろう。"
           "<b>同じ場所で撮るものは本をまたいでまとめている</b> ── 店の前で⑤と⑧、店内で⑤と⑧。"
           "午後は事務所の机で⑦を撮り切り、そのあと購入者インタビュー。",
 ...
 dict(key="d3", no="工房の日", place="向島工房", theme="佐藤さんのインタビューと、機械の前ごとに二本",
      ...
      lead="朝いちばんに佐藤さんのインタビューを録り、そのあとは<b>②と⑥を本ごとに撮らず、機械の前ごとにまとめて撮る。</b>"
           "裁断機なら②の裁つと⑥の裁断を続けて、ミシンなら②の縫うと⑥の縫製を続けて。"
 ...
 dict(key="d4", no="モデルの日", place="東京国際フォーラム → 表参道",
      ...
      lead="午前に東京国際フォーラム、午後に表参道へ移る。同じ出演者で二本撮れるので、手配は一度で済む。"
           "<b>⑤の冒頭の俯瞰も、表参道に着いたらいちばんに撮る。</b>"
           "<b>④は最初と最後が同じ柵なので、一度の設営でまとめて撮る。</b>",
...
<div style="width: {PAGE_W}px; height: {HEIGHT["cover"]}px; background: #ffffff; padding: {MARGIN}px; box-sizing: border-box; display: flex; flex-direction: column; gap: 22px">
  ...
  <div style="font-size: 18px; line-height: 1.9; color: {MUTED}">
    ...
    <b>インタビューの日・店の日は、ブルックリンの製作日を待たずに押さえられます</b>（画に入るのは自社の品だけ）。<br>
